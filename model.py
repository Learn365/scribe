...
class Model:
    def __init__(self, args, logger):
        ...
        self.window_b_initializer = tf.truncated_normal_initializer(mean=-3.0, stddev=.25, seed=None,
        ...
        if args.optimizer == 'adam':
            ...
            self.optimizer = tf.train.RMSPropOptimizer(learning_rate=self.learning_rate, decay=self.decay,
